...
func (v *TermView) draw() {
	...
	case mvc.UpdateInstalling:
		updateMsg = "github.com/x-insane/ngrokex is updating"
	case mvc.UpdateReady:
		updateMsg = "github.com/x-insane/ngrokex has updated: restart ngrok for the new version"
	...
	v.APrintf(termbox.ColorBlue|termbox.AttrBold, 0, 0, "github.com/x-insane/ngrokex")
